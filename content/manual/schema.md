...
molecules with up to 8 attributes including up to 3 [input attributes](/manual/query/parameterize). 
...
If you at some point need to make molecules with more than 22 attributes
  you can insert/query in two steps as described [here](/manual/query/builder).
...
[Create database](/manual/schema/transaction)...
